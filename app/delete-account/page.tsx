...
export default function DeleteAccountPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#1B1D33] text-[#FFFFFF]">
      <div
        aria-hidden="true"
      ...
      <div className="relative">
        ...
        <main className="mx-auto max-w-4xl space-y-8 px-6 py-12 sm:px-10 sm:py-16 lg:px-12 lg:py-20">
          <header className="mx-auto max-w-3xl space-y-4 text-center">
            ...
            <h1 className="font-italiana text-4xl text-[#FFFFFF] sm:text-5xl">
          ...
          <section className="rounded-3xl border border-white/15 bg-white/10 p-6 shadow-xl backdrop-blur-sm sm:p-8">
            ...
            <h2 className="mt-2 font-marcellus text-2xl text-[#FFFFFF]">The fastest option</h2>
            <ol className="mt-5 space-y-3 text-body text-[#ECECF3]">
              <li><strong className="text-[#FFFFFF]">1.</strong> Sign in to the iPurpose mobile app.</li>
              <li><strong className="text-[#FFFFFF]">2.</strong> Open the <strong>Account</strong> tab and scroll to <strong>Delete account</strong>.</li>
              <li><strong className="text-[#FFFFFF]">3.</strong> Read the warning and enter your password to confirm your identity.</li>
              <li><strong className="text-[#FFFFFF]">4.</strong> Select <strong>Permanently delete account</strong>.</li>
            </ol>
          </section>

          <section className="rounded-3xl border border-white/15 bg-white/5 p-6 backdrop-blur-sm sm:p-8">
            <h2 className="font-marcellus text-2xl text-[#FFFFFF]">If you cannot access the app</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <section className="rounded-3xl border border-white/15 bg-white/5 p-6 backdrop-blur-sm sm:p-8">
              <h2 className="font-marcellus text-2xl text-[#FFFFFF]">What is deleted</h2>
            ...
            <section className="rounded-3xl border border-white/15 bg-white/5 p-6 backdrop-blur-sm sm:p-8">
              <h2 className="font-marcellus text-2xl text-[#FFFFFF]">Limited data retention</h2>
              <p className="mt-3 text-body text-[#E2E3EB]">
          ...
          <section className="rounded-3xl border border-[#E6C87C]/30 bg-[#E6C87C]/10 p-6 sm:p-8">
            <h2 className="font-marcellus text-2xl text-[#FFFFFF]">Purchases and shared spaces</h2>
