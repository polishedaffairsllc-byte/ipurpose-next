...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-lavenderViolet/10 px-2 py-2">
        ...
        <div className="ipurpose-glow-container w-full">
          <div className="relative ipurpose-card px-4 py-6 md:px-6 md:py-7 flex flex-col items-center">
            <div className="text-center mb-4 w-full">
              <h1 className="heading-hero mb-1 text-2xl md:text-3xl">Welcome to iPurpose</h1>
              <p className="font-marcellus text-warmCharcoal/70 text-sm md:text-base">Log in to access your dashboard and AI tools</p>
            </div>
