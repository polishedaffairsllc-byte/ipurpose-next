  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center w-screen h-screen">
        <div className="bg-black shadow-xl w-full h-full pt-20 px-0 pb-0 backdrop-blur-md z-50 flex flex-col justify-center items-center relative" style={{ background: 'rgba(0,0,0,0.92)', zIndex: 50, width: '100vw', height: '100vh', borderRadius: 0, paddingTop: '5rem', paddingLeft: 0, paddingRight: 0, paddingBottom: 0, opacity: 0.92 }}>
          {/* Close Button */}
