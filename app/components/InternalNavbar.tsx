...
export default function InternalNavbar() {
  ...
  // Show authenticated journey nav for orientation and integration
  ...
  // For other authenticated routes (dashboard, labs when not in orientation flow, etc)
  // Return the standard authenticated navigation for dashboard
  if (pathname === '/dashboard' || pathname.startsWith('/dashboard/') || 
      ...
      pathname === '/soul' || pathname.startsWith('/soul/')) {
    return (
      <nav className="sticky top-0 z-50 bg-[#141527]/95 backdrop-blur-sm border-b border-white/5">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
