...
const navItems = [
  ...
  { label: 'Week 1', href: '/starter-pack/week/1', color: '#9C88FF' },
  { label: 'Week 2', href: '/starter-pack/week/2', color: '#FCC4B7' },
  { label: 'Week 3', href: '/starter-pack/week/3', color: '#4B4E6D' },
  { label: 'Week 4', href: '/starter-pack/week/4', color: '#E6C87C' },
  { label: 'Week 5', href: '/starter-pack/week/5', color: '#88b04b' },
  { label: 'Week 6', href: '/starter-pack/week/6', color: '#d4af37' },
  { label: 'Deepen', href: '/deepen', color: '#fcc4b7' },
];

export default function StarterPackNav() {
      ...
      <div className="flex items-center w-full gap-2 p-4 overflow-x-auto">
        ...
        <form action="/api/auth/logout" method="post">
          <button
            type="submit"
            className="flex-1 px-4 py-2 rounded-full font-italiana text-center hover:opacity-90 transition-opacity whitespace-nowrap"
            style={{ background: 'linear-gradient(to right, #d4af37, rgba(212, 175, 55, 0.3))', color: '#FFFFFF', fontSize: '10vw', lineHeight: 1.1 }}
          >
            Logout
          </button>
        </form>
