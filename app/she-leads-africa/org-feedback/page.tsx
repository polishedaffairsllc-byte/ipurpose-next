      ...
      <div style={containerStyle}>
        <div style={{ ...cardStyle, textAlign: 'center', padding: '64px 48px' }}>
          ...
          <p style={{
            ...
            Thank you for taking the time to share She Leads Africa's perspective.
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <div style={{ marginBottom: 40, borderBottom: `2px solid ${C.peach}`, paddingBottom: 32 }}>
          <Label>Organizational Feedback · She Leads Africa × iPurpose™</Label>
          <h1 style={{
            fontSize: 28,
            fontFamily: "'Marcellus', Georgia, serif",
            color: C.indigo,
          ...
          <p style={{
            ...
            shape any future collaboration between iPurpose™ and She Leads Africa.
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: '#888', fontFamily: "'Inter', sans-serif", marginBottom: 14 }}>
            Optional — helps us attribute this feedback correctly.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div>
              <label style={{ fontSize: 12, color: C.indigo, display: 'block', marginBottom: 6, fontFamily: "'Inter', sans-serif" }}>Your name</label>
              <input
                type="text"
            ...
            <div>
              <label style={{ fontSize: 12, color: C.indigo, display: 'block', marginBottom: 6, fontFamily: "'Inter', sans-serif" }}>Email address</label>
              <input
                type="email"
                value={respondentEmail}
                onChange={(e) => setRespondentEmail(e.target.value)}
                placeholder="you@sheleadsafrica.org"
                style={{ ...inputStyle, fontSize: 13 }}
              />
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FieldBlock number={1} label="How did the session land with your community overall?">
            <textarea
              ...
              style={{ ...textareaStyle, paddingLeft: 42, paddingLeft: 14 }}
            />
          </FieldBlock>
