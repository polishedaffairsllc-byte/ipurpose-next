      ...
      <div className="container max-w-2xl mx-auto px-6 py-20">
        {!submitted ? (
          <div>
            ...
            <p className="text-body text-warmCharcoal/75 text-center mb-12">
            ...
            <div className="bg-gradient-to-br from-lavenderViolet/5 to-salmonPeach/5 rounded-2xl p-6 border border-lavenderViolet/10 mb-8">
              <p className="text-body text-warmCharcoal/75">
                <strong>Next Session:</strong> Coming soon (dates announced to registrants)
              </p>
              <p className="text-body text-warmCharcoal/75 mt-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-gradient-to-br from-lavenderViolet/5 to-salmonPeach/5 rounded-2xl p-8 border border-lavenderViolet/10">
              <div>
                <label className="text-body block font-medium text-warmCharcoal mb-2">
                  Your Name
                </label>
                <input
                  type="text"
                  ...
                  className="text-body w-full px-4 py-3 rounded-lg border border-lavenderViolet/20 bg-white text-warmCharcoal placeholder-warmCharcoal/50 focus:outline-none focus:ring-2 focus:ring-lavenderViolet/50"
              ...
              <button
                type="submit"
                disabled={loading}
                className="text-body w-full bg-gradient-to-r from-lavenderViolet to-indigoDeep text-white py-3 px-6 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 cursor-disabled"
              >
                {loading ? 'Registering...' : 'Reserve My Spot'}
              </button>

              <p className="text-body-small text-warmCharcoal/60 text-center">
