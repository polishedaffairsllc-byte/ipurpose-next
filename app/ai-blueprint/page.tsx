      ...
      <div className="bg-gradient-to-br from-lavenderViolet/5 via-transparent to-salmonPeach/5">
        <div className="container max-w-4xl mx-auto px-6 py-20">
          ...
          <div className="space-y-4 text-lg text-warmCharcoal/80">
            ...
            <p>
              <strong>You're ready to move faster</strong> without losing what makes your work yours.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-marcellus text-warmCharcoal mb-2">
                  Use AI Confidently for Real Work
                </h3>
                <p className="text-warmCharcoal/70">
                  Not just theory—practical prompts for projects you're actually doing this week.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-warmCharcoal/70">
                  A system you can return to weekly, that fits your actual process.
                </p>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-marcellus text-warmCharcoal mb-2">
                  Feel Clear About What to Automate
                </h3>
                <p className="text-warmCharcoal/70">
                  You'll know what to delegate to AI and what to keep human. No guilt, just clarity.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container max-w-4xl mx-auto px-6 py-20">
          ...
          <div className="space-y-6 text-lg text-warmCharcoal/80">
            <div>
              ...
              <p>Digital guide with templates and worksheets</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>Self-guided (no live calls, but designed for fast implementation)</p>
            </div>
          </div>
        </div>
      </div>
