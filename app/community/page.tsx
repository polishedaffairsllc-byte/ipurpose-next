  ...
  return (
    <div className="container max-w-6xl mx-auto px-6 md:px-10 py-10">
      ...
      <div className="mb-8 relative rounded-3xl p-12 min-h-[600px]" style={{
        ...
        <div className="absolute top-20 left-1/4 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#f44336',
        ...
        <div className="absolute top-1/2 right-12 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#d32f2f',
        ...
        <div className="absolute bottom-1/4 left-1/3 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#f44336',
        ...
        <div className="absolute top-2/3 right-1/3 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#d32f2f',
        ...
        <div className="absolute bottom-1/3 right-1/3 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#f44336',
        ...
        <div className="absolute top-1/4 right-1/3 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#d32f2f',
        ...
        <div className="absolute bottom-1/2 left-1/4 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#f44336',
        ...
        <div className="absolute top-3/4 left-1/2 pointer-events-none z-10">
          <div style={{
            width: '16px',
            height: '16px',
            backgroundColor: '#d32f2f',
