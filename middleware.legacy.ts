// Legacy middleware preserved for reference during proxy migration.
// This file was renamed from `middleware.ts` when migrating to `app/proxy.ts`.
// Keep this file for rollback or reference; it is not loaded by Next.js.
